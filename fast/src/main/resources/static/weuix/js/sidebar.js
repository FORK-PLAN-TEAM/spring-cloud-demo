    ...
    var sidebarjs_1 = createCommonjsModule(function (module, exports) {
        ...
        var SidebarJS = (function () {
            function SidebarJS(_d, _a) {
                ...
                var _b = _a === void 0 ? {} : _a, component = _b.component, container = _b.container,
                    background = _b.background, documentMinSwipeX = _b.documentMinSwipeX,
                    documentSwipeRange = _b.documentSwipeRange, nativeSwipe = _b.nativeSwipe,
                    nativeSwipeOpen = _b.nativeSwipeOpen, position = _b.position;
            ...
            SidebarJS.prototype.setPosition = function (position) {
                ...
                POSITIONS.forEach(function (POS) {
                    return _this.component.classList.remove(sidebarjs + "--" + POS);
                });
                this.component.classList.add(sidebarjs + "--" + (this.hasRightPosition() ? RIGHT_POSITION : LEFT_POSITION));
                setTimeout(function () {
                    return _this.component.classList.remove(isMoving);
                }, TRANSITION_DURATION);
            };
